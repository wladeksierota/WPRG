...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'sentCV') {
        ...
        VALUES ('$fname', '$lname', '$message', '$email', '$phone', '$fileContent', 'analyst')";
...
<div class="main">
    ...
    <ul>
        <li>3+ years in role of System Analyst</li>
    ...
    <ul>
        ...
        <li>Communication bridge between customer and developers</li>
        <li>Project documenting eg. system analysis, high level design, use cases</li>
    </ul>

    <div>
        <h2 class="p_title">Benefits:</h2>
        <ul>
            <li>8,5k+ PLN monthly (B2B or permanent contract)</li>
    ...
    <a class="GB" href="main_site.phpl#UP">Go back to main page &#8594;</a>
