...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'sentCV') {
        ...
        VALUES ('$fname', '$lname', '$message', '$email', '$phone', '$fileContent', 'project manager')";
...
<div class="main">
    ...
    <ul>
        <li>5+ years in role of PM or Scrum Master</li>
        <li>Background in Agile and Waterfall projects</li>
        <li>Software development hands-on experience (any SDLC role)</li>
    </ul>

    <h2 class="p_title">Skills:</h2>
    <ul>
        <li>Strong communication skills</li>
        <li>Problem solving and negotiations</li>
        <li>Analytical thinker</li>
        <li>Self starting and well organized</li>
        <li>English speaking</li>
    </ul>

    <h2 class="p_title">Key responsibilities:</h2>
    <ul>
        <li>Scope and time management</li>
        <li>Stakeholder and communication management</li>
        <li>Team leading</li>
        <li>Progress and status reporting</li>
        <li>Backlog management</li>
        <li>Risk and problem analysis and solving</li>
    ...
    <div>
        ...
        <ul>
            <li>10k+ PLN monthly (B2B or permanent contract)</li>
            <li>Additional benefits (depending on KPI achievements)</li>
